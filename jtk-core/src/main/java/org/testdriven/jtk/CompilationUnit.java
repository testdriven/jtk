...
class CompilationUnit {
    ...
    public File getClassFile(String classesDir) throws FileNotFoundException {
        ...
        if(sourceFilePath.startsWith(baseDirPath)){
            String localSourcePath = sourceFilePath.substring(baseDirPath.length()+1);
        ...
        throw new FileNotFoundException("Source directory doesnt match source file location");
    }
